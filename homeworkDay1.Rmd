...
<iframe 
    height=450 
    width=800 
    src="https://youtu.be/MLTlH7KB0Xk" 
    frameborder=0 
    allowfullscreen>
</iframe>
...
$$ E\lbrack var \lbrace v_1(\hat{\theta},n\vert \hat{\theta})\rbrace\rbrack=
var\lbrace v_1(\theta_0,n)\rbrace+O(n_{-2}). $$
 ...
 **some important information:something**
</td></tr></table>



<p type="background-color:Green">Some important Info:something</p>
